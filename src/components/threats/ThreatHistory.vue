        ...
        <v-timeline v-if="audits.length">
          ...
          >
            ...
            <v-card dark color="red darken-2">
              <v-card-title class="text-h5 red darken-2" v-if="n.type == 1" :tabIndex="(tab_idx+= 1)">{{
                $t("threats.modified_threat")
              }}</v-card-title>
              <v-card-title class="text-h5 red darken-2" v-if="n.type == 0" :tabIndex="(tab_idx+= 1)">{{
                $t("threats.created_threat")
              }}</v-card-title>
              <v-card-text class="white text--primary">
                <div v-if="n.name_new || n.name_old">
                  <br />
                  <div v-if="n.name_new && n.name_old" :tabIndex="(tab_idx+= 1)">
                ...
                <div v-if="n.description_new || n.description_old">
                  ...
                  <div v-if="n.description_new && n.description_old" :tabIndex="(tab_idx+= 1)">
                    <b class="d-inline text-truncate trunc">{{ $t("threats.updated_description") }}:
                    </b>
                    <span class="d-inline-block text-truncate trunc">{{
                      n.description_new
                    }}</span>
                    ...
                    <span class="d-inline-block text-truncate trunc"><strike>{{ n.description_old }}</strike></span
                    >
                    <template>
                      <v-icon
                        small
                ...
                <div v-if="n.threat_type_name_new || n.threat_type_name_old">
                  <br />
                  <div v-if="n.threat_type_name_new && n.threat_type_name_old" :tabIndex="(tab_idx+= 1)">
                ...
                <div v-if="n.asset_name_new || n.asset_name_old">
                  <br />
                  <div v-if="n.asset_name_new && n.asset_name_old" :tabIndex="(tab_idx+= 1)">
                ...
                <div v-if="n.impact_new || n.impact_old">
                  <br />
                  <div v-if="n.impact_new && n.impact_old" :tabIndex="(tab_idx+= 1)">
                ...
                <div v-if="n.likelihood_new || n.likelihood_old">
                  <br />
                  <div v-if="n.likelihood_new && n.likelihood_old" :tabIndex="(tab_idx+= 1)">
                ...
                <div v-if="n.observation" :tabIndex="(tab_idx+= 1)">
                  <br />
                  <hr />
                  <br />
